...
public class ManHinhChinh extends JFrame {
	...
	private ManHinhDatTour datTour;
	//
...
//	                login.main(null);
		...
		btnNewButton.setIcon(
				new ImageIcon(ManHinhChinh.class.getResource("/images/341216476_608902234206627_540418413920865547_n.png")));
		...
		item1.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				datTour = new ManHinhDatTour(tourID1.getText().substring(9));
		...
		item2.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				datTour = new ManHinhDatTour(tourID2.getText().substring(9));
				datTour.setVisible(true);
			}
		});
		...
		item3.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				datTour = new ManHinhDatTour(tourID3.getText().substring(9));
				datTour.setVisible(true);
			}
		});
		...
		item4.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				datTour = new ManHinhDatTour(tourID4.getText().substring(9));
				datTour.setVisible(true);
			}
		});
		...
		item5.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				datTour = new ManHinhDatTour(tourID5.getText().substring(9));
				datTour.setVisible(true);
			}
		});
		...
		item6.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				datTour = new ManHinhDatTour(tourID6.getText().substring(9));
				datTour.setVisible(true);
			}
		});
		...
		btnReset.setIcon(new ImageIcon(ManHinhChinh.class.getResource("/images/reset_undo_arrow_icon_149006 (1).png")));
