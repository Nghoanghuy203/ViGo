...
public class ThongTinGioHang extends JFrame{
	...
	public ThongTinGioHang() {
		...
		for (DonDatTour donDatTour: donDatTour_BUS.timKiem(ManHinhChinh.user.getSoNguoiDung())) {
	...
	public static void main(String[] args) {
		new ThongTinGioHang().setVisible(true);
	}
}
